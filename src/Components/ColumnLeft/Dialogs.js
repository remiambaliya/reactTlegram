...
class Dialogs extends Component {
    ...
    onClientUpdatePageWidth = update => {
        ...
        const { openSettings, openContacts, openSearch, openNewGroup, openNewChannel, openWallet } = this.state;
        if (openSettings || openContacts || openSearch || openNewGroup || openNewChannel, openWallet) {
            this.setState({
                    openContacts: false,
                    openSettings: false,
                    openSearch: false,
            ...
            <>
                <div className='dialogs'>
                    ...
                    <SidebarPage open={openNewChannel} timeout={timeout} onClose={this.handleCloseNewChannel}>
                     ...
                     <SidebarPage open={openWallet} timeout={timeout} onClose={this.handleCloseWallet}>
                        <Wallet />
                    </SidebarPage>
